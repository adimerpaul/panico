    ...
    <q-card-section>
      <q-form  @submit.prevent="userSave">
        ...
        <div class="col-12 col-6">
          <q-input outlined v-model="store.user.name" label="Nombre completo" hint="" required />
        </div>
        <div class="col-12 col-6">
          <q-input outlined v-model="store.user.email" label="Correo" hint="" required/>
        </div>
        <div class="col-12 col-6">
          <q-input outlined v-model="store.user.phone" label="Telefono" hint="" required/>
        </div>
        <div class="col-12 col-6">
          <q-input outlined v-model="store.user.address" label="Direccion" hint="" required/>
        </div>
...
export default {
  ...
  methods: {
    ...
    userSave(){
      ...
      this.store.user.avatar=this.foto
